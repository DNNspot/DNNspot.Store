...
{
    public class StoreCheckoutModuleBase : StoreModuleBase
    {
        protected CartController cartController;
        //protected DataModel.Cart cart;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            {
                checkoutOrderInfo = new CheckoutOrderInfo() { Cart = cartController.GetCart(false) };
            }
        }
