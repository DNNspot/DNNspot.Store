...
namespace DNNspot.Store.Shipping
{
    ...
    {
        public static IShippingService Get(int storeId, ShippingProviderType providerType)
        {
            ...
            switch (providerType)
            {
                ...
                case ShippingProviderType.FedEx:
                    return new FedExShippingService(storeId);
                case ShippingProviderType.UPS:
                    return new UpsShippingService(storeId);
            }
            return null;
        }   
